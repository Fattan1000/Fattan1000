...
<body>
	<div class="main_container">
     ...
     <form method="post" action="result.php">
		<div class="container">
		<h1 class="">Prenez un rendez-vous avec le medecin  le plus proche de vous online </h1>
			<div class="search"><input id="search"type="text" placeholder="Nom,Specialite,Ville..." name="search_button">
			<select name="search-specialite" id="search-specialite" class="option">
        ...
        <select name="search-ville" id="search-ville" class="option">
