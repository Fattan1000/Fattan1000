        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Historique Medicale de <?php echo htmlspecialchars("$patientnom $patientprenom");?></p>
                    ...
                    <td width="15%">
                        ...
                        <p class="heading-sub12" style="padding: 0;margin: 0;">
                            <?php 
                       $list110 =mysqli_query($conn, "SELECT patient_id FROM rendez_vouz WHERE medecin_id = $docid AND rendez_vouz.status = 'terminer' AND patient_id = $patientid");
                        ?>
                        </p>
                    </td>
                    <td width="10%">
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <a href="?action=view&id='.$idRDV.'&idpatient='.$patientid.'&patientnom='.$patientnom.'&patientprenom='.$patientprenom.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Voir</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
