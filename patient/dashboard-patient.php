        ...
        <!--for demo wrap-->
            ...
            <table class="recus"cellpadding="0" cellspacing="0" border="0">
                ...
                <tr >
                   ...
                   $sqlmai = "SELECT rendez_vouz.id,date_rdv,rendez_vouz.status FROM medecin INNER JOIN rendez_vouz ON rendez_vouz.medecin_id = medecin.id WHERE  rendez_vouz.patient_id = $patid  ORDER BY date_rdv ASC";
                   ...
                   $sqlmain = "SELECT rendez_vouz.id,rendez_vouz.description,date_rdv,rendez_vouz.status,medecin.nom,heure_debut_rdv, medecin.prenom, medecin.email FROM medecin INNER JOIN rendez_vouz ON rendez_vouz.medecin_id = medecin.id WHERE  date_rdv > CURDATE() and rendez_vouz.patient_id = $patid  ORDER BY date_rdv ASC";
